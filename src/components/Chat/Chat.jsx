...
const Chat = () => {
  ...
  const makeTeacherChatAvailable = async () => {
    try {
      ...
      await axios.post(
        `${BASE_URL}/maketeacherchatavailable`,
        {
          groupId,
        },
        {
  ...
  const checkChatAvailability = async () => {
    try {
      ...
      const res = await axios.get(
        `${BASE_URL}/isteacherchatavailableforinst?groupId=${StreamKey}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        ...
        <div className="bg-white shadow-md rounded-lg max-w-lg w-full h-full flex flex-col justify-between">
          <div className="p-4 border-b bg-green-500 text-white flex justify-between">
            <div className="flex gap-2">
              ...
              <p
                className={`text-lg font-semibold cursor-pointer ${
                  chatMode === "teacher" ? "text-red-500 border-b-2" : ""
                }`}
            ...
            <div>
              <p
                className={`text-lg font-semibold cursor-pointer ${
                  chatMode === "live" ? "text-red-500 border-b-2" : ""
                }`}
          ...
          <div className="p-4 border-t bg-gray-100">
            ...
            <select
              ...
              className="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#1DBF73]"
            >
